...
class _$changeCategory implements changeCategory {
  const _$changeCategory({required this.index});
  ...
  @override
  String toString() {
    return 'HomepageState.changeCategory(index: $index)';
  }
...
abstract class changeCategory implements HomepageState {
  const factory changeCategory({required final int index}) = _$changeCategory;
